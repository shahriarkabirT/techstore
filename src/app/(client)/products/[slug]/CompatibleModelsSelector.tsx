        ...
        <div>
            ...
            <div className="mt-2">
                <select
                    ...
                    className="w-full px-3 py-2 border rounded-lg text-sm bg-white transition-all focus:outline-none focus:ring-1 appearance-none bg-no-repeat bg-right border-gray-300 text-gray-700 focus:border-gray-900 focus:ring-gray-900 hover:border-gray-400"
                    style={{

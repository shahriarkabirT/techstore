...
export default function EditPolicyPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        const fetchPolicy = async () => {
            try {
                ...
                if (res.data.success) {
                    ...
                    // Auto-detect: if content looks like HTML, default to html mode
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const res = await axios.put(`/api/policies/${id}`, formData);
            if (res.data.success) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight uppercase">Edit Policy</h1>
                    <p className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mt-0.5">Update store policy</p>
                </div>
            </div>

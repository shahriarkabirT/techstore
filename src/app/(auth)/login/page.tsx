            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl shadow-gray-200/50">
                ...
                <form className="mt-0 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-end">
                        <Link href="/forgot-password" className="text-sm font-bold text-gray-500 hover:text-primary transition-colors">
                            Forgot Password?
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        <div className="text-sm">
                            ...
                            <Link href="/register" className="font-bold text-primary hover:text-gray-900 transition-colors">
                                Create one now
                            </Link>
                        </div>
                    </div>
